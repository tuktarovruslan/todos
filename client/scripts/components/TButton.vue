...
const props = {
  ...
  litetext: { type: Boolean, default: false },
...
.fill:active {
  border: 3px solid $logoclk;
}

.inactive {
  border: 3px solid $comments;
